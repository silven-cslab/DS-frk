/** ===== Circular Single Linked List: Operations Implementation ===== **/


/** ===== Documentation ===== **/
/*
 * This program shows the implementation of the operations on a Circular Single Linked List.
 * In this we do the following processes:
	...
	* Reverse the circular single linked list.
...
int insertPos(int, struct node *);
int insertEnd(struct node *);
int deleteMain(void);
...
int main()
{
	...
	printf("\n\n ====== Circular Singly Linked List : Operations Implementations ====== \n\n");
	printf("\n   -------------------------------------------------------------   \n");
...
int insertMain(int size)
{
	...
	if(choice1 == 1)
	{
		if(insertFront(newNode)) return 1;
	}
	else if(choice1 == 2)
	{
		if(insertPos(size, newNode)) return 1;
	}
	else if(choice1 == 3)
	{
		if(insertEnd(newNode)) return 1;
	}
	else
	{
		printf("\nInvalid Option!!");
...
int insertFront(struct node *new)
{
...
int insertPos(int size, struct node *new)
{
	int pos, j=0;
